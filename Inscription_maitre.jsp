...
<body>
<form id = "inscription_form2" method = "post" action = "<?php echo $_SERVER['PHP_SELF']; ?>">
	...
	<p><label for = "passe_con">Confirmation du mot de passe *:</label> <input type = "password" name = "passe_con" id = "passe_con" required/><?php if ($flagp == 1) echo '<em style = "color : red;">Le mot de passe de confirmation ne correspond pas</em>'; ?></p>
