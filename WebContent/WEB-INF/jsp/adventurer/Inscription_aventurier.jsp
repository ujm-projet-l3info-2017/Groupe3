	...
	<div class="content">
		...
		<form id = "inscription_form1" method = "post" action = "inscription_aventurier">
			...
			<fieldset id="zone_obligatoire">
				...
				<p>
					<label for="niveau">Niveau <span class="requis">*</span></label> <select
			...
			<fieldset id = "zone_facultative">
					...
					<input type = "text" name = "departement" id = "departement" value="<c:out value="${ utilisateur.dpt }" />" size="20" maxlength="60" />
					</p>
